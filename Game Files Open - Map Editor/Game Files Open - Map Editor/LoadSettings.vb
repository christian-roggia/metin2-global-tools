Imports System.IO
Module LoadSettings
    Public Function LoadSettings(ByVal path As String)
        ...
        If Not CheckString("SCRIPTTYPEMAPSETTING", PathSettings, "Impossible to check the ScriptType") = "ERROR" Then
            ...
            frmMapEditor.DisplayValue(CellScale, HeightScale, ViewRadius, MapSize, BasePosition, TextureSet, Environment)
        End If
        Return 0
    End Function

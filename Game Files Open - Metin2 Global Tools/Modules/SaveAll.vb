...
Module SaveAll
    Public Sub SaveCMapSettings(ByVal TextBoxes() As String, ByVal TextSettings() As String, ByVal GCDirName As String)
        Dim TextToWrite As String = "ScriptType" & Chr(9) & "MapSetting" & Chr(13) & Chr(10) & Chr(13) & Chr(10)

        For t = 0 To TextBoxes.Length - 1
            TextToWrite += TextSettings(t) & Chr(9) & TextBoxes(t).Replace(" x ", Chr(9)) & Chr(13) & Chr(10)
        Next t
